(function() {
    ...
    mt.p.Sa = function(a, d) {
        ...
        document.addEventListener ? k = function() {
            ...
            if (!e) if (e = r, "complete" === document.readyState) a.z = r;
    ...
    mt.j.stringify = function() {
        ...
        return function(f) {
            ...
            default:
                ...
                n = ["{"];
                p = mt.j.stringify;
                for (m in f) if (Object.prototype.hasOwnProperty.call(f, m)) switch (g = f[m], typeof g) {
                case "undefined":
                case "unknown":
                case "function":
                    break;
    ...
    mt.url.Ta = function(a) {
        ...
        function a() {
            for (var a = u,
            e = document.getElementsByTagName("script"), f = e.length, f = 100 < f ? 100 : f, k = 0; k < f; k++) {
                var m = e[k].src;
    ...
    h.C = {
        ...
        function e(b) {
            ...
            l = "";
            if (b in a) l = b;
            else for (var t = ["webkit", "ms", "moz", "o"], d = 0; d < t.length; d++) {
        ...
        d(); (function() {
            ...
            "object" == typeof document.onfocusin ? (k.c(document, "focusin", f), k.c(document, "focusout", f)) : (k.c(window, "focus", f), k.c(window, "blur", f))
        })();
        h.D = {
            oa: function() {
                return + new Date - w
        ...
        function a(b, a, l, t) {
            if (! (b === q || a === q || t === q)) {
                ...
                b = String(b).split("!");
                for (var d, f = u,
                e = 0; e < b.length; e++) if (d = b[e].split("*"), String(a) === d[0]) {
                    d[1] = l;
                    d[2] = t;
                    b[e] = d.join("*");
                    f = r;
        ...
        g = {
            ...
            ia: function() {
                if (0 < g.r.length) for (var b = 0,
                a = g.r.length; b < a; b++) g.M(g.r[b]);
                g.r = s
            },
            M: function(b) {
                var a = b[0];
            ...
            _setAutoPageview: function(b) {
                if (1 < b.length && (b = b[1], u === b || r === b)) g.e |= 2,
                h.b.T = b
            },
            ...
            _setCustomVar: function(b) {
                if (! (4 > b.length)) {
                    ...
                    if (0 < a && 6 > a && 0 < l && 4 > l) {
                        ...
                        "" !== b ? h.b.setData("Hm_cv_" + c.id, encodeURIComponent(b), c.age) : h.b.Aa("Hm_cv_" + c.id)
                    }
                }
            },
            _setUserTag: function(b) {
                if (! (3 > b.length)) {
                    ...
                    b = e(b[2]);
                    if (d !== q && b !== q) {
                        var l = decodeURIComponent(h.b.getData("Hm_ct_" + c.id) || ""),
                        l = a(l, d, 1, b);
            ...
            _trackRTPageview: function(b) {
                b = b[1];
                f.d(b, "Object") && (d(b), b = k.stringify(b), 512 >= encodeURIComponent(b).length && (g.e |= 64, h.b.a.rt = b))
            },
            _trackRTEvent: function(b) {
                ...
                if (f.d(b, "Object")) {
                    ...
                    l = b.length;
                    if (900 >= l) a.call(this, b);
                    else for (var l = Math.ceil(l / 900), e = "block|" + Math.round(Math.random() * m.L).toString(16) + "|" + l + "|", v = [], x = 0; x < l; x++) v.push(x),
                    v.push(b.substring(900 * x, 900 * x + 900)),
                    a.call(this, e + v.join("|")),
                    v = []
                }
            },
        ...
        a.prototype = {
            ...
            w: function(b) {
                for (var a = 0; a < c.dm.length; a++) if ( - 1 < c.dm[a].indexOf("/")) {
            ...
            H: function() {
                for (var b = document.location.hostname,
                a = 0,
                d = c.dm.length; a < d; a++) if (this.J(b, c.dm[a])) return c.dm[a].replace(/(:\d+)?[\/\?#].*/, "");
                return b
            },
            R: function() {
                for (var b = 0,
            ...
            Fa: function() {
                var a, d, f, e, g;
                b.o = this.getData("Hm_lpvt_" + c.id) || 0;
                ...
                if (0 === c.nv && this.w(document.location.href) && ("" === document.referrer || this.w(document.referrer))) a = 0,
                d = 4;
                this.a.nv = a;
                this.a.st = d;
                this.a.cc = f;
            ...
            Ca: function() {
                ...
                this.T ? (this.I = r, this.a.et = 0, this.a.ep = "", this.h(a)) : a()
            },
            h: function(a) {
                var d = this;
            ...
            da: function() {
                ...
                e = RegExp(c.id),
                f = -1 < document.referrer.indexOf(b.ba),
                g = d.f(a, "jn"),
                k = /^heatlink$|^select$/.test(g);
                a && (e.test(a) && f && k) && (this.a.rnd = Math.round(Math.random() * b.L), a = document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", b.protocol + "//" + c.js + g + ".js?" + this.a.rnd), g = document.getElementsByTagName("script")[0], g.parentNode.insertBefore(a, g))
            },
            aa: function(a) {
            ...
            N: function(a) {
                var b = g.get("Hm_unsent_" + c.id) || "";
                b && (a = encodeURIComponent(a.replace(/^https?:\/\//, "")), a = RegExp(a.replace(/([\*\(\)])/g, "\\$1") + "(%26u%3D[^,]*)?,?", "g"), (b = b.replace(a, "").replace(/,$/, "")) ? g.set("Hm_unsent_" + c.id, b) : g.remove("Hm_unsent_" + c.id))
            },
            Da: function() {
                var a = this,
                d = g.get("Hm_unsent_" + c.id);
                if (d) for (var d = d.split(","), f = function(d) {
                    e.log(b.K + "//" + decodeURIComponent(d),
                    function(b) {
                        a.N(b)
                    })
                },
        ...
        try {
            if (window.performance && performance.timing && "undefined" !== typeof h.b) {
                ...
                var p = function() {
                    ...
                    v = s;
                    d = s;
                    if ("www.baidu.com" === p[2] || "m.baidu.com" === p[2]) v = e.f(a, "qid"),
                    d = e.f(a, "click_t");
                    a = v;
                    g.qid = a != s ? a: "";
        ...
        if ("undefined" !== typeof h.b && (c.med || (!a.za || 7 < a.xa) && c.cvcc)) {
            ...
            w = function(a, b) {
                ...
                if (b) {
                    ...
                    m = b.getAttribute("id") || "";
                    n.test(g) ? (e.sn = "mediate", e.snv = g) : d.d(l, "String") && n.test(l) && (e.sn = "wrap", e.snv = l);
                    e.id = m
                }
                h.b.a.et = 86;
            ...
            p = {
                click: function() {
                    for (var a = [], b = g(document.getElementsByTagName("a")), b = [].concat.apply(b, g(document.getElementsByTagName("area"))), b = [].concat.apply(b, g(document.getElementsByTagName("img"))), d, e, f = 0, k = b.length; f < k; f++) d = b[f],
                ...
                p = {
                    click: function() {
                        for (var a = [], b = g(document.getElementsByTagName("a")), b = [].concat.apply(b, g(document.getElementsByTagName("area"))), b = [].concat.apply(b, g(document.getElementsByTagName("img"))), d, e, f, k = 0, m = b.length; k < m; k++) d = b[k],
                        n !== q ? (e = d.getAttribute("onclick"), f = d.getAttribute("href"), l ? (d = d.getAttribute("id"), (n.test(e) || n.test(f) || l.test(d)) && a.push(b[k])) : (n.test(e) || n.test(f)) && a.push(b[k])) : l !== q && (d = d.getAttribute("id"), l.test(d) && a.push(b[k]));
                        return a
                    }
                }
            }
            if ("undefined" !== typeof p && "undefined" !== typeof n) {
                ...
                m += /\/$/.test(m) ? "": "/";
                var v = function(a, b) {
                    if (t === b) return w(m + a, b),
                    u;
                    if (d.d(b, "Array") || d.d(b, "NodeList")) for (var e = 0,
                    f = b.length; e < f; e++) if (t === b[e]) return w(m + a + "/" + (e + 1), b[e]),
                    u
                };
        ...
        if ("undefined" !== typeof h.b && d.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var k = {
                $: function() {
                    ...
                    f, p = 0; p < d; p++)(f = a.la(decodeURIComponent(c.cvcf[p]))) && e.c(f, "click", k.ga())
                },
                ga: function() {
                    return function() {
                        h.b.a.et = 86;
