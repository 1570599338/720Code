(function(config) {
    ...
    function ha() {
        ...
        return 0 <= a.indexOf("nvidia") || 0 <= a.indexOf("quadro") || 0 <= a.indexOf("geforce") || 0 <= a.indexOf("nvs") ? (b = ["nVidia"], 0 <= a.indexOf("geforce") && b.push("geForce"), 0 <= a.indexOf("quadro") && b.push("Quadro"), 0 <= a.indexOf("nvs") && b.push("NVS"), a.match(/\bion\b/) && b.push("ION"), a.match(/gtx\b/) ? b.push("GTX") : a.match(/gts\b/) ? b.push("GTS") : a.match(/gt\b/) ? b.push("GT") : a.match(/gs\b/) ? b.push("GS") : a.match(/ge\b/) ? b.push("GE") : a.match(/fx\b/) && b.push("FX"), (c = a.match(ga)) && b.push(c[1].toUpperCase().replace("GS", "")), 0 <= a.indexOf("titan") ? b.push("TITAN") : 0 <= a.indexOf("ti") && b.push("Ti"), b = b.join(" ")) : 0 <= a.indexOf("amd") || 0 <= a.indexOf("ati") || 0 <= a.indexOf("radeon") || 0 <= a.indexOf("firegl") || 0 <= a.indexOf("firepro") ? (b = ["AMD"], 0 <= a.indexOf("mobil") && b.push("Mobility"), c = a.indexOf("radeon"), 0 <= c && b.push("Radeon"), 0 <= a.indexOf("firepro") ? b.push("FirePro") : 0 <= a.indexOf("firegl") && b.push("FireGL"), 0 <= a.indexOf("hd") && b.push("HD"), 0 <= c && (a = a.substring(c)), (c = a.match(ga)) && b.push(c[1].toUpperCase().replace("HD", "")), b = b.join(" ")) : a.substring(0, 100)
    }
    ...
    cb = T("firefox"),
    db = cb && 27 < parseInt(ba.split("firefox/")[1]),
    ...
    Cb = !sb || Ta || ua || ib && cb || Pa || Ca || ya || za || Ha || T("gt-n710") || ta,
    ...
    Qb = !0;
    try {
        if ("undefined" === typeof e.localStorage) Qb = !1;
        else {
    ...
    config.j = {
        ...
        gM: kb,
        hM: lb,
        dX: 57 <= parseInt(ba.split("chrome/")[1]),
        p3: Fb,
        g6: pb,
        q3: Gb,
        A5: Hb,
    ...
    config.Fd += "c";
    config.j.Ke && (config.Fd += "v", Ub += ",vectorlayer,overlay", config.j.Zd ? (config.Fd += "w", Ub += ",wgl") : (config.Fd += "cg", Ub += ",cmng,cgl"));
    if (config[7]) {
    ...
    config.wg = "1500010318915";
    var Zb = window.AMap.SC = {},
    mc = config[2].split(",")[0],
    nc = mc + "/theme/v" + config[4] + "/style1500010318915.css",
    ...
    function qc(a) {
        ...
        c.charset = "utf-8";
        c.src = a; (a = b.body || oc) && a.appendChild(c)
    }
    function rc() {
        for (var a = mc + "/maps/main?v=" + config[4] + "&key=" + config[0] + "&m=" + config.zN.join(",") + "&vrs=1500010318915", b = document.getElementsByTagName("script"), c, d = 0; d < b.length; d += 1) if (0 === b[d].src.indexOf(mc.split(":")[1] + "/maps?")) {
            c = b[d];
            break
        }
    ...
    try {
        if (window.localStorage) {
            ...
            if (uc) for (Xb in window.localStorage) window.localStorage.hasOwnProperty(Xb) && 0 === Xb.indexOf("_AMap_") && window.localStorage.removeItem(Xb)
        }
    } catch(vc) {}
    Zb.loaded || (rc(), delete config.zN);
})(["2d55bb94475c6821816a95dd15918ea7", [115.423411, 39.442758, 117.514625, 41.060816, 116.405285, 39.904989], "https://webapi.amap.com", 1, "1.3", "init", "110000", "", true, true, true, true, "1499778953-1"])